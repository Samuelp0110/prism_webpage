  ...
  return (
    ...
    >
      <button
        ...
        className='inline-flex items-center rounded-full p-4 bg-gradient-to-r from-purple-400/20 via-cyan-500/20 to-primary/20 shadow-lg ring-1 ring-primary/5 backdrop-blur-lg text-secondary'
      >
        {isPlaying ? (
